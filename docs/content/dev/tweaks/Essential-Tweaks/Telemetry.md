...
<!-- winutil-devdocs: tweaks/WPFTweaksTelemetry; schema=1 -->

> 本页由 tools/devdocs-generator.ps1 生成，请修改源配置或函数后重新生成。目录保留历史 URL，实际分类以本页为准。

- 稳定 ID：`WPFTweaksTelemetry`
- 当前分类：z__高级设置 - 先了解影响
- 源配置：`config/tweaks.json`
- 源配置 SHA-256：`3e7f3f2dc0b37b3a858d3faf8151aa53c1ffd5a9bc1baa24e82ad364a5a28952`

关闭 Microsoft 遥测与部分相关数据收集；保留 Defender 自动样本提交设置。
...
```json
{
  "WPFTweaksTelemetry": {
    "Content": "禁用遥测",
    "Description": "关闭 Microsoft 遥测与部分相关数据收集；保留 Defender 自动样本提交设置。",
